// ===== ПОЛНАЯ ВЕРСИЯ products.js (ИСПРАВЛЕННАЯ) =====
(function() {
    console.log('🟢 Запуск products.js');
    ...
    function loadData() {
        ...
        if (saved) {
            try {
                ...
                console.log(`Загружено товаров: ${products.length}, категорий: ${categories.length}`);
        ...
        if (categories.length === 0) {
            ...
            console.log('Добавлены демо-категории');
        }
    ...
    function closeSidebar() { sidebar?.classList.remove('open'); overlay?.classList.remove('active'); editingId = null; document.getElementById('productForm')?.reset(); if(sidebarTitle) sidebarTitle.innerText = 'Добавить товар'; }
